    ...
    return (
        ...
        >
            ...
            <div
                ...
                style={{
                    backgroundColor: theme === 'dark' ? '#8B5CF6' : '#D8B4FE',
                }}
            ></div>
            ...
            <div
                ...
                style={{
                    backgroundColor: theme === 'dark' ? '#14B8A6' : '#5EEAD4',
                }}
            ></div>

            <div className="rounded-2xl overflow-hidden m-5 lg:m-0 lg:rounded-tl-2xl lg:rounded-bl-2xl">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
                        <div className="w-full xl:col-span-6 lg:col-span-6 text-center lg:text-left animate-fade-in motion-reduce:animate-none">
                            ...
                            >
                                Hi, I’m{" "}
                                <span
                                    className={theme === "dark" ? "text-blue-400" : "text-darkBlue"}
                                >
                                    Sushmitha
                                </span>
                            </h1>
                            ...
                            >
                                I craft sleek, responsive, and accessible interfaces while ensuring every
                                feature is thoroughly tested for performance and reliability. Blending
                                creativity with precision, I transform concepts into seamless digital
                                experiences.
                            </p>
